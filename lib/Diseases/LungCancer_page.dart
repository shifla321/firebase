...
class LungCancer_page extends StatefulWidget {
  const LungCancer_page({super.key});

  @override
  State<LungCancer_page> createState() => _LungCancer_pageState();
}

class _LungCancer_pageState extends State<LungCancer_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("LungCancer",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
