...
class COPD_page extends StatefulWidget {
  const COPD_page({super.key});

  @override
  State<COPD_page> createState() => _COPD_pageState();
}

class _COPD_pageState extends State<COPD_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("COPD",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
              ...
              Container(
                    ...
                    decoration: BoxDecoration(
                      image: const DecorationImage(
                        image: AssetImage("images/COPD.png"),fit: BoxFit.cover,
                      ),
                  ...
                  Expanded(
                    child: TabBarView(children: [
                      const Column(children: [Text("COPD",style: const TextStyle(fontSize: 32),),
                      SizedBox(
                        height: 20,
                      ),
