              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("Asthma",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
              ...
              Container(
                  ...
                  Expanded(
                    child: TabBarView(children: [
                      const Column(children: [Text("Asthma",style: const TextStyle(fontSize: 32),),
                      SizedBox(
                        height: 20,
                      ),
