...
class ParkinsonDisease_page extends StatefulWidget {
  const ParkinsonDisease_page({super.key});

  @override
  State<ParkinsonDisease_page> createState() => _ParkinsonDisease_pageState();
}

class _ParkinsonDisease_pageState extends State<ParkinsonDisease_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("Parkinson's Diseases",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
