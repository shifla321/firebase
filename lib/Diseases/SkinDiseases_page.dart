...
class SkinDiseases_page extends StatefulWidget {
  const SkinDiseases_page({super.key});

  @override
  State<SkinDiseases_page> createState() => _SkinDiseases_pageState();
}

class _SkinDiseases_pageState extends State<SkinDiseases_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("Skin Diseases",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
