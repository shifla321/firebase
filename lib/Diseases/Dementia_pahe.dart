...
class Dementia_page extends StatefulWidget {
  const Dementia_page({super.key});

  @override
  State<Dementia_page> createState() => _Dementia_pageState();
}

class _Dementia_pageState extends State<Dementia_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("Dementia",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
