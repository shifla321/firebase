...
class Stroke_page extends StatefulWidget {
  const Stroke_page({super.key});

  @override
  State<Stroke_page> createState() => _Stroke_pageState();
}

class _Stroke_pageState extends State<Stroke_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("Stroke",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
