...
class Pneumonia_page extends StatefulWidget {
  const Pneumonia_page({super.key});

  @override
  State<Pneumonia_page> createState() => _Pneumonia_pageState();
}

class _Pneumonia_pageState extends State<Pneumonia_page> {
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text("Pneumonia",style: TextStyle(fontSize: 26,fontWeight: FontWeight.normal,color: HexColor("553504")),),
                  ),
