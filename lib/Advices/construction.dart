...
class constrution_page extends StatefulWidget {
  const constrution_page({super.key});

  @override
  State<constrution_page> createState() => _construtions_pageState();
}

class _construtions_pageState extends State<constrution_page> {
    ...
    return  Scaffold(
      body: Column(
        children: [
            ...
            Positioned(
              ...
              child: Padding(
                ...
                child: Container(  
                  ...
                  child: Image.asset("images/pregnant.png",fit: BoxFit.cover,),
            ),
          ),   
    ),
              ]
          ...
          Text('Advice for Constrution in Polluted Areas:',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
          Expanded(
