...
class outdoor_page extends StatefulWidget {
  const outdoor_page({super.key});

  @override
  State<outdoor_page> createState() => _outdoor_pageState();
}

class _outdoor_pageState extends State<outdoor_page> {
    ...
    return  Scaffold(
      body: Column(
        children: [
          ...
          Text('Advice for Outdoor Workers in Polluted Areas:',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
          Expanded(
