...
class pregnant_page extends StatefulWidget {
  const pregnant_page({super.key});

  @override
  State<pregnant_page> createState() => _pregnant_pageState();
}

class _pregnant_pageState extends State<pregnant_page> {
    ...
    return  Scaffold(
      body: Column(
        children: [
            ...
            Positioned(
              ...
              child: Padding(
                ...
                child: Container(  
                  ...
                  child: Image.asset("assets/images/pregnant.png",fit: BoxFit.cover,),
            ),
          ),   
    ),
              ]
          ...
          Text('Advice for Pregnant in Polluted Areas:',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
          Expanded(
